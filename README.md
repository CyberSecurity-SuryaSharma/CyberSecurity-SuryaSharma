...
Role        : Casual Lecturer @ Curtin University | DevSecOps Engineer
Focus       : Cybersecurity · DevSecOps · Linux Security · Cloud · Web Dev
Education   :
  - MSc Computing (Cybersecurity) — Curtin University (2022–2024)
  - BSc Computing (First Class Honours) — Leeds Beckett University
Currently   : Teaching Linux Security & Computing to bachelor-level students
...
- Secure SSH, PAM, SUID/SGID, Firewall Config
...
- Freelance Web Dev & SEO (Perth)
- 3D DYO Tool Development

</td>
<td width="50%" valign="top">

### 🎓 Teaching & Mentoring
- Casual Lecturer @ Curtin University
- Linux Fundamentals & Security
- DevOps Concepts & Cloud (AWS)
- Support Tutor for Neurodivergent Students
- Coder Dojo Mentor
...
|-------|--------------|--------|------|
| 🔴 | Incident Responder Essentials | OffSec | 2024 |
...
- 🎓 **Curtin International Scholarship** — Merit Award
- 👨‍🏫 **University Lecturer** — Teaching cybersecurity to next-gen professionals
- 🤝 **Accessibility Advocate** — Supporting neurodivergent students at Curtin & Coder Dojo
